...
| [ADR-0023](ADR-0023-personal-golden-vm-onboarding.md) | Personal golden-VM onboarding (Ubuntu + LabVIEW CE) for the community | LINUX | Accepted | LBA-REQ-033, LBA-REQ-038, LBA-REQ-039, LBA-REQ-044, LBA-REQ-046, LBA-REQ-047, LBA-REQ-048 |
...
| [ADR-0031](ADR-0031-cross-plane-vi-analyzer-determinism.md) | Cross-plane VI Analyzer determinism: the same config yields the same resultHash across LabVIEW planes | LINUX | Accepted | LBA-REQ-043 |

...
### 2.1 Local gate suite — 149 fail-closed checks
...
| --- | --- | --- |
| Requirements (total) | 51 | docs/requirements/srs.md, rtm.csv |
| — Status: Proven | 51 | rtm.csv |
| Architecture decisions (ADRs) | 33 | docs/architecture/adr/README.md |
| Governed gates | 149 | experiments/verify-local-gates.mjs |
| Correspondence rules | 7 | experiments/reqs-coverage/verify-correspondences.mjs |
| Governed test items | 51 | docs/testing/test-plan.md |
...
_Generated from 149 gates, 7 correspondence rules, 51 requirements, 33 ADRs, 51 test items._

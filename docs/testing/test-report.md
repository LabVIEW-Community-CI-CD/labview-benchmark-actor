...
### 2.1 Local gate suite — 195 fail-closed checks
...
| Governed gates | 195 | experiments/verify-local-gates.mjs |
...
_Generated from 195 gates, 7 correspondence rules, 93 requirements, 76 ADRs, 92 test items._

...
### 2.1 Local gate suite — 167 fail-closed checks
...
| --- | --- | --- |
| Requirements (total) | 71 | docs/requirements/srs.md, rtm.csv |
| — Status: Proven | 70 | rtm.csv |
| — Status: Superseded | 1 | rtm.csv |
| Architecture decisions (ADRs) | 52 | docs/architecture/adr/README.md |
| Governed gates | 167 | experiments/verify-local-gates.mjs |
| Correspondence rules | 7 | experiments/reqs-coverage/verify-correspondences.mjs |
| Governed test items | 71 | docs/testing/test-plan.md |
...
_Generated from 167 gates, 7 correspondence rules, 71 requirements, 52 ADRs, 71 test items._

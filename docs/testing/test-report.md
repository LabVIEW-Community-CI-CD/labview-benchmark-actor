...
### 2.1 Local gate suite — 175 fail-closed checks
...
| --- | --- | --- |
| Requirements (total) | 79 | docs/requirements/srs.md, rtm.csv |
| — Status: Proven | 78 | rtm.csv |
| — Status: Superseded | 1 | rtm.csv |
| Architecture decisions (ADRs) | 60 | docs/architecture/adr/README.md |
| Governed gates | 175 | experiments/verify-local-gates.mjs |
| Correspondence rules | 7 | experiments/reqs-coverage/verify-correspondences.mjs |
| Governed test items | 79 | docs/testing/test-plan.md |
...
_Generated from 175 gates, 7 correspondence rules, 79 requirements, 60 ADRs, 79 test items._

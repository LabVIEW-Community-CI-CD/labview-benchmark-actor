...
### 2.1 Local gate suite — 133 fail-closed checks
...
| --- | --- | --- |
| Requirements (total) | 37 | docs/requirements/srs.md, rtm.csv |
| — Status: Planned | 1 | rtm.csv |
| — Status: Proven | 36 | rtm.csv |
| Architecture decisions (ADRs) | 27 | docs/architecture/adr/README.md |
| Governed gates | 133 | experiments/verify-local-gates.mjs |
| Correspondence rules | 7 | experiments/reqs-coverage/verify-correspondences.mjs |
| Governed test items | 37 | docs/testing/test-plan.md |
...
_Generated from 133 gates, 7 correspondence rules, 37 requirements, 27 ADRs, 37 test items._

...
| Architecture decisions (ADRs) | 47 | docs/architecture/adr/README.md |
...
_Generated from 163 gates, 7 correspondence rules, 67 requirements, 47 ADRs, 67 test items._

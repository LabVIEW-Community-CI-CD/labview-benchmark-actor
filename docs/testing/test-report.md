...
### 2.1 Local gate suite — 181 fail-closed checks
...
| Governed gates | 181 | experiments/verify-local-gates.mjs |
...
_Generated from 181 gates, 7 correspondence rules, 85 requirements, 66 ADRs, 85 test items._

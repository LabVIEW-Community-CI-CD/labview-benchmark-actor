...
### 2.1 Local gate suite — 192 fail-closed checks
...
| Governed gates | 192 | experiments/verify-local-gates.mjs |
...
_Generated from 192 gates, 7 correspondence rules, 92 requirements, 75 ADRs, 91 test items._

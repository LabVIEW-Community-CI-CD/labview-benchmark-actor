...
### 2.1 Local gate suite — 148 fail-closed checks
...
| — Status: Proven | 50 | rtm.csv |
| Architecture decisions (ADRs) | 32 | docs/architecture/adr/README.md |
| Governed gates | 148 | experiments/verify-local-gates.mjs |
...
_Generated from 148 gates, 7 correspondence rules, 50 requirements, 32 ADRs, 50 test items._

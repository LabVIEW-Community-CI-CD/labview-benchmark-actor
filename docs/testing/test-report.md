...
### 2.1 Local gate suite — 136 fail-closed checks
...
| Governed gates | 136 | experiments/verify-local-gates.mjs |
...
_Generated from 136 gates, 7 correspondence rules, 39 requirements, 27 ADRs, 39 test items._

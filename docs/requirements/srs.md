...
- Change Guidance: Sub-requirement of LBA-REQ-023 (ADR-0015). DELIVERED as
  ...
  `acg-quorum-compare-witnesses`. Authored under the `repo-standards-review`
